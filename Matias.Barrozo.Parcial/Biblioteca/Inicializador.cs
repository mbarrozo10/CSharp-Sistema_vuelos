...
namespace Biblioteca
{
    public class Inicializador
    {
        ...
        public static List<Vuelo> InicializarVuelos()
        {
            ...
            vuelos.Add(new Vuelo(Aerolina.aviones[2], 10, 1000, Destino.Miami, Estado.Disponible, "Buenos Aires", DateTime.Parse("10:30:00"), InicializarPasajeros()));
            vuelos.Add(new Vuelo(Aerolina.aviones[0], 4, 200, Destino.Mendoza, Estado.EnVuelo));
            vuelos.Add(new Vuelo(Aerolina.aviones[1], 4, 200, Destino.Neuquén, Estado.Lleno));
